      ...
      >
        ...
        <div>
          <div className="flex justify-center items-center">
            <div
              className=" w-[75%] bg-base rounded-lg py-5"
              style={{
                display: "flex",
            ...
            >
              <p
                ...
                style={{
                  fontSize: 16,
                  fontWeight: 500,
                  color: isEdit ? "#09B782" : "#818181",
                  cursor: "pointer",
                  borderBottom: isEdit ? "3px solid #09B782" : "none",
                  padding: "6px 0px",
                }}
              >
                Edit Profile
              ...
              <p
                ...
                style={{
                  fontSize: 16,
                  fontWeight: 500,
                  color: isEdit ? "#818181" : "#09B782",
                  cursor: "pointer",
                  borderBottom: isEdit ? "none" : "3px solid #09B782",
                  padding: "6px 0px",
                }}
              >
                Change Password
          ...
          <ConfigProvider>
            {isEdit ? (
              ...
              <div className=" flex justify-center items-center">
                <div
                  className=" bg-base w-[75%] p-[40px] rounded-lg"
                  style={{
                    display: "flex",
                    justifyContent: "center",
                    alignItems: "center",
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ marginBottom: "30px" }} className="space-y-1">
                      <label
                        style={{
                          margin: "0px 0px",
                          color: "#757575",
                    ...
                    <div style={{ marginBottom: "40px" }} className="space-y-1">
                      <label
                        style={{
                          margin: "0px 0px",
                          color: "#757575",
